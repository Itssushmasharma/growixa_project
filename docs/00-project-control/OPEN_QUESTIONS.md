...
| OQ-002 | Which email provider is the one production adapter for MVP (e.g. SES, Postmark, SendGrid, Mailgun)? | Slice 3 (First Email Campaign) | OPEN — does not block Slice 1 |
