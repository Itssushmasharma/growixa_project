...
async def create_agency(
    data: AgencyCreate,
    user_id: Annotated[uuid.UUID, Depends(require_permission("company.settings.edit"))],
...
async def get_agency(
    ...
    return await services.get_agency(session, agency_id, user_id)
...
async def create_agency_client(
    ...
    return await services.create_agency_client(session, agency_id, data, user_id)
...
async def list_agency_clients(
    ...
    return await services.get_agency_clients(session, agency_id, user_id)
...
async def update_white_label(
    ...
    return await services.update_white_label_config(session, agency_id, data, user_id)
...
async def get_white_label(
    ...
    return await services.get_white_label_config(session, agency_id, user_id)
