...
export const DOC_CATEGORIES: DocCategory[] = [
  ...
  },
  {
    ...
    description:
      "Manage subscribers, custom fields, dynamic segments, suppression lists, and contact lifecycle.",
    icon: "👥",
    color: "#10b981",
    articles: [
      {
        ...
        sections: [
          {
            ...
            content:
              "The **Contacts Dashboard** (`/dashboard/contacts`) gives you a single overview of your entire audience. You can filter by status (**All**, **Active**, **Archived**), search across names, emails, and sources, and paginate across large contact databases.",
          },
          {
            id: "custom-fields",
      ...
      },
      {
        ...
        category: "contacts",
        title: "Contact Lifecycle, Statuses & Archiving",
        excerpt:
          "Understand how active, archived, and suppressed statuses impact your audience targeting and quota limits.",
        icon: "🔄",
        readingTimeMinutes: 4,
        lastUpdated: "2026-08-17",
        tags: ["lifecycle", "archiving", "status", "retention", "quota"],
        sections: [
          {
            id: "status-meanings",
            title: "Contact Status Breakdown",
            content:
              "- **Active**: Subscribed contacts eligible to receive marketing and broadcast campaigns. Only active contacts count against your account contact quota (`max_contacts`).\n- **Archived**: Inactive contacts excluded from regular campaign dispatches while preserving historical campaign delivery metrics.\n- **Suppressed**: Permanently blocked from receiving campaigns due to unsubscribes, spam complaints, or hard bounces.",
          },
          {
            id: "archiving-contacts",
            title: "Archiving vs Managing Contacts",
            content:
              "Archiving allows you to remove inactive subscribers from your active campaigns and quota without losing past analytics and campaign engagement history.",
          },
        ],
        relatedSlugs: ["contact-management", "suppression-and-consent"],
      },
  ...
  },
  {
    ...
    articles: [
      ...
      },
      {
        ...
        excerpt:
          "Connect any standard SMTP provider (for example Amazon SES, SendGrid, Mailgun, or your own mail server).",
        icon: "⚙️",
        readingTimeMinutes: 4,
        lastUpdated: "2026-08-17",
