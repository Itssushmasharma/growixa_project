...
import styles from "./ai-and-cta.module.css";
...
const CLAIMS: ClaimItem[] = [
  {
    ...
    proof: [
      "→ read <b>northwind.io</b>",
      "→ found: usage-based pricing, hiring GTM",
      "→ angle: <b>&ldquo;scaling before hiring&rdquo;</b>",
    ],
  },
  {
    hue: "qualify",
  ...
  },
  {
    ...
    proof: [
      "email <b>94w</b> &nbsp;·&nbsp; linkedin <b>212c</b> &nbsp;·&nbsp; sms <b>148c, gsm-7, 1 segment</b> &nbsp;·&nbsp; whatsapp <b>template-safe</b>",
    ],
  },
];
    ...
    <section className={styles.cta}>
      <Wrap className={styles.ctaWrap}>
        ...
        <p className={styles.ctaP}>
          Start with email campaigns &mdash; live today, free to try. The rest of the engine
          switches on as it ships.
        </p>
        <div className={styles.ctaActions}>
          <Button as={Link} href="/register" variant="onstage">
            Start free
          </Button>
          <Button as={Link} href="/contact" variant="ghoststage">
            Talk to a founder
          </Button>
        </div>
