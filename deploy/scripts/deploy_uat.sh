...
Inspect before retrying:
  ...
  sudo ss -ltnp 'sport = :5433'

After confirming the legacy containers are the old UAT stack and not serving live traffic,
stop and remove only the containers, not volumes:
  cd ${UAT_DIR}
